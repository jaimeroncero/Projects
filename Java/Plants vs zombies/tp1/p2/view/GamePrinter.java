...
public class GamePrinter {
	...
	protected String getInfo() {
		...
		buffer.append(Messages.NUMBER_OF_CYCLES).append(" ").append(this.game.getCycle()).append(NEW_LINE)
			.append(Messages.NUMBER_OF_COINS).append(" ").append(this.game.getSuncoins()).append(NEW_LINE)
			.append(Messages.REMAINING_ZOMBIES).append(" ").append(this.game.getRemainingZombies()).append(NEW_LINE)
			.append(Messages.GENERATED_SUNS).append(" ").append(this.game.getGeneratedSuns()).append(NEW_LINE)
			.append(Messages.CAUGHT_SUNS).append(" ").append(this.game.getCaughtSuns()).append(NEW_LINE)
			.append(Messages.SCORE).append(" ").append(this.game.getScore()).append(NEW_LINE);
	...
	public String endMessage() {
		if(game.isFinished() || game.isPlayerQuits()) {
			
			StringBuilder str = new StringBuilder(Messages.GAME_OVER).append(NEW_LINE);
			
			if(game.getPlantsWin()) 
				str.append(Messages.PLAYER_WINS);
			
			else if(game.getZombiesWin())
				str.append(Messages.ZOMBIES_WIN);
			
			else str.append(Messages.PLAYER_QUITS);
